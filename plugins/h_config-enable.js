...
{title: "📵 | ANTISPAM", description: "𝙰𝙲𝚃𝙸𝚅𝙰 𝙾 𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰 𝙴𝙻 𝙰𝙽𝚃𝙸 𝙻𝙻𝙰𝙼𝙰𝙳𝙰", rowId: `${usedPrefix + command} antispam`},
...
┣ ඬ⃟ℹ️ _${usedPrefix}on/off *anticall*_
┣ ඬ⃟ℹ️ _${usedPrefix}on/off *antispam*_
┗━━━━━━━━━━━━━┛
${author}`,
title: null,
...
📣 𝐏𝐀𝐑𝐀: ${isAll ? '𝙴𝚂𝚃𝙴 𝙱𝙾𝚃' : isUser ? '' : '𝙴𝚂𝚃𝙴 𝙲𝙷𝙰𝚃'}`, author, null, [[`${isEnable ? '' : ''}`, `${isEnable ? `.off ${type}` : `.on ${type}`}`]],m)}
