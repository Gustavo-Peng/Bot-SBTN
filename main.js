...
browser: ['El bot Otaku','Opera','1.0.0']
}
...
if (connection == 'open') {
console.log(chalk.yellow('▣─────────────────────────────···\n│\n│❧ CONECTADO CON EXITO A WHATSAPP ✅\n│\n▣─────────────────────────────···'))}
}
...
conn.bye = '┏━━━━━━━━━━━━\n┃──〘 *ADIOS* 〙───\n┃━━━━━━━━━━━━\n┃ *_☠️Se fue un/a soldado @user_* \n┃ *_lo estaremos esperando para la siguiente batalla_* \n┃ *_Esperaremos su regreso_*\n┗━━━━━━━━━━'
conn.spromote = '*@user SE SUMA AL GRUPO DE ADMINS!!*'
conn.sdemote = '*@user ABANDONA EL GRPO DE ADMINS !!*'
...
conn.sRevoke = '*SE HA ACTUALIZADO EL LINCK DEL GRUPO!!*\n*𝙻𝙸𝙽𝙺 𝙽𝚄𝙴𝚅𝙾:* @revoke'
